...
!function(t, e) {
    ...
    function lt(t, e) {
        var e = 1 < arguments.length && void 0 !== e && e
          , n = V();
        bt(n) && (e && (n.style.transition = "none",
        n.style.width = "100%"),
        setTimeout(function() {
    ...
    function pt(t) {
        xn.isVisible() && ht !== t.target.value && xn.resetValidationMessage(),
        ht = t.target.value
    }
    function ft(t, e) {
    ...
    var ht, gt = function(t, e) {
        ...
        var e, n, o, i, r, a = !!(i = C()) && (i.parentNode.removeChild(i),
        vt([document.documentElement, document.body], [$["no-backdrop"], $["toast-shown"], $["has-column"]]),
        !0);
        dt() ? W("SweetAlert2 requires document to initialize") : ((r = document.createElement("div")).className = $.container,
    ...
    function At(t, e, n) {
        var o;
        st(t, n["show".concat((o = e).charAt(0).toUpperCase() + o.slice(1), "Button")], "inline-block"),
    ...
    function Pt(t, e) {
        var n, o, i = C();
        i && (o = i,
        "string" == typeof (n = e.backdrop) ? o.style.background = n : n || gt([document.documentElement, document.body], $["no-backdrop"]),
        !e.backdrop && e.allowOutsideClick && z('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`'),
        o = i,
        (n = e.position)in $ ? gt(o, $[n]) : (z('The "position" parameter is not valid, defaulting to "center"'),
        gt(o, $.center)),
        n = i,
        !(o = e.grow) || "string" != typeof o || (o = "grow-".concat(o))in $ && gt(n, $[o]),
        F(i, e, "container"),
    ...
    var St = {
      ...
      , Lt = function(t) {
        if (!jt[t.input])
            return W('Unexpected type of input! Expected "text", "email", "password", "number", "tel", "select", "radio", "checkbox", "textarea", "file" or "url", got "'.concat(t.input, '"'));
        var e = qt(t.input)
          , n = jt[t.input](e, t);
        it(n),
        setTimeout(function() {
    ...
    jt.text = jt.email = jt.password = jt.number = jt.tel = jt.url = function(t, e) {
        return "string" == typeof e.inputValue || "number" == typeof e.inputValue ? t.value = e.inputValue : b(e.inputValue) || z('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(r(e.inputValue), '"')),
        Ot(t, t, e),
        Et(t, e),
        t.type = e.input,
        t
    ...
    jt.textarea = function(e, t) {
        ...
        Et(e, t),
        Ot(e, e, t),
        "MutationObserver"in window && (n = parseInt(window.getComputedStyle(x()).width),
    ...
    function Mt(t, e) {
        ...
        e.html ? (ft(e.html, n),
        it(n, "block")) : e.text ? (n.textContent = e.text,
        it(n, "block")) : rt(n),
        t = t,
        o = e,
        i = P(),
    ...
    function Rt(t, o) {
        ...
        r >= o.progressSteps.length && z("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"),
    ...
    function Ht(t, e) {
        ...
        function(t, e) {
            t = St.innerParams.get(t);
            t && e.icon === t.icon && B() ? Ft(B(), e) : (_t(),
            e.icon && (-1 !== Object.keys(J).indexOf(e.icon) ? (t = k(".".concat($.icon, ".").concat(J[e.icon])),
            it(t),
            Wt(t, e),
            Ft(t, e),
            gt(t, e.showClass.icon)) : W('Unknown icon! Expected "success", "error", "warning", "info" or "question", got "'.concat(e.icon, '"'))))
        }(t, e),
        function(t) {
            var e = E();
            if (!t.imageUrl)
    ...
    var _t = function() {
      ...
      , Zt = []
      , Qt = function(t, e) {
        t.className = "".concat($.popup, " ").concat(bt(t) ? e.showClass.popup : ""),
        e.toast ? (gt([document.documentElement, document.body], $["toast-shown"]),
        gt(t, $.toast)) : gt(t, $.modal),
        F(t, e, "popup"),
    ...
    function ne(t) {
        for (var e in t)
            ...
            t.toast && (n = e,
            -1 !== se.indexOf(n) && z('The parameter "'.concat(n, '" is incompatible with toasts'))),
            ee(n = e) && g(n, ee(n));
        var n, o
    }
    var oe = {}
    ...
    function ue() {
        var t, e;
        St.innerParams.get(this) && (t = St.domCache.get(this),
        rt(t.loader),
        (e = t.popup.getElementsByClassName(t.loader.getAttribute("data-button-to-replace"))).length ? it(e[0], "inline-block") : bt(T()) || bt(L()) || bt(I()) || rt(t.actions),
    ...
    function le() {
        null === G.previousBodyPadding && document.body.scrollHeight > window.innerHeight && (G.previousBodyPadding = parseInt(window.getComputedStyle(document.body).getPropertyValue("padding-right")),
        document.body.style.paddingRight = "".concat(G.previousBodyPadding + function() {
    ...
    function be(t, e, n, o) {
        ...
        N() && (null !== G.previousBodyPadding && (document.body.style.paddingRight = "".concat(G.previousBodyPadding, "px"),
    ...
    function we(t) {
        var e, n, o, i = x();
        i && (t = Ce(t),
        (e = St.innerParams.get(this)) && !_(i, e.hideClass.popup) && (n = ye.swalPromiseResolve.get(this),
    ...
    var xe = function(t, e, n) {
      ...
      , Be = function(t, e, n, o) {
        ...
        e.addEventListener(Bt, function(t) {
            t.target === e && (oe.swalCloseEventFinishedCallback(),
    ...
    function Te(t) {
        ...
        (n = t).target && ("string" != typeof n.target || document.querySelector(n.target)) && ("string" == typeof n.target || n.target.appendChild) || (z('Target parameter is not valid, defaulting to "body"'),
        n.target = "body"),
    ...
    function Le(t) {
        ...
        N() && (Ve(e, t.scrollbarPadding, o),
        h(document.body.children).forEach(function(t) {
            t === C() || function(t, e) {
                if ("function" == typeof t.contains)
                    return t.contains(e)
            }(t, C()) || (t.hasAttribute("aria-hidden") && t.setAttribute("data-previous-aria-hidden", t.getAttribute("aria-hidden")),
            t.setAttribute("aria-hidden", "true"))
        })),
        X() || oe.previousActiveElement || (oe.previousActiveElement = document.activeElement),
        je(n, t),
        vt(e, $["no-transition"])
    }
    function De(t) {
    ...
    var je = function(t, e) {
      ...
      , Me = function(t, e) {
        Bt && ut(e) ? (t.style.overflowY = "hidden",
        e.addEventListener(Bt, De)) : t.style.overflowY = "auto"
    }
      , Ve = function(t, e, n) {
        var o;
      ...
      , Re = function(t, e, n) {
        ...
        n.heightAuto && n.backdrop && !n.toast && gt([document.documentElement, document.body], $["height-auto"])
    }
      , He = function(t) {
      ...
      , _e = function(e, n) {
        ...
        var i = P();
        v(n.inputOptions) || b(n.inputOptions) ? ($t(),
      ...
      , Ye = function(t, e, n) {
        ...
        e.inputValidator ? Ze(t, e, o) : t.getInput().checkValidity() ? ("deny" === n ? Qe : $e)(t, e, o) : (t.enableButtons(),
      ...
      , tn = function(t, e, n) {
        ...
        "Enter" === e.key ? en(t, e, o) : "Tab" === e.key ? nn(e, o) : -1 !== [].concat(Je, Xe).indexOf(e.key) ? on(e.key) : -1 !== Ge.indexOf(e.key) && rn(e, o, n)
    }
      , en = function(t, e, n) {
        e.isComposing || e.target && t.getInput() && e.target.outerHTML === t.getInput().outerHTML && -1 === ["textarea", "file"].indexOf(n.input) && (Ut(),
        e.preventDefault())
    }
      , nn = function(t) {
      ...
      , on = function(t) {
        -1 !== [T(), L(), I()].indexOf(document.activeElement) && (t = -1 !== Je.indexOf(t) ? "nextElementSibling" : "previousElementSibling",
        (t = document.activeElement[t]) && t.focus())
    }
      , rn = function(t, e, n) {
        Y(e.allowEscapeKey) && (t.preventDefault(),
        n(Z.esc))
    }
      , an = function(e, t, n) {
    ...
    function pn(a, s, c) {
        return new Promise(function(t) {
            ...
            s.confirmButton.onclick = function() {
                return e = c,
                (t = a).disableButtons(),
                void (e.input ? Ye(t, e, "confirm") : $e(t, e, !0));
                var t, e
            }
            ,
            s.denyButton.onclick = function() {
                return e = c,
                (t = a).disableButtons(),
                void (e.returnInputValueOnDeny ? Ye(t, e, "deny") : Qe(t, e, !1));
                var t, e
            }
            ,
            ...
            r = s,
            t = e,
            St.innerParams.get(n).toast ? an(n, r, t) : (cn(r),
            un(r),
            ln(n, r, t)),
            o = a,
            r = c,
            i = e,
            (t = oe).keydownTarget && t.keydownHandlerAdded && (t.keydownTarget.removeEventListener("keydown", t.keydownHandler, {
            ...
            (c.toast && (c.input || c.footer || c.showCloseButton) ? gt : vt)(document.body, $["toast-column"]),
            r = a,
            "select" === (t = c).input || "radio" === t.input ? _e(r, t) : -1 !== ["text", "email", "number", "tel", "textarea"].indexOf(t.input) && (v(t.inputValue) || b(t.inputValue)) && Fe(r, t),
            Le(c),
            mn(oe, c, e),
            hn(s, c),
            setTimeout(function() {
    ...
    var mn = function(t, e, n) {
        var o = V();
        rt(o),
        e.timer && (t.timeout = new Oe(function() {
            n("timer"),
            delete t.timeout
        }
        ,e.timer),
        e.timerProgressBar && (it(o),
        setTimeout(function() {
      ...
      , hn = function(t, e) {
        if (!e.toast)
            return Y(e.allowEnterKey) ? void (gn(t, e) || qe(0, -1, 1)) : vn()
    }
      , gn = function(t, e) {
        return e.focusDeny && bt(t.denyButton) ? (t.denyButton.focus(),
        !0) : e.focusCancel && bt(t.cancelButton) ? (t.cancelButton.focus(),
        !0) : !(!e.focusConfirm || !bt(t.confirmButton)) && (t.confirmButton.focus(),
        !0)
    }
      , vn = function() {
    ...
    var wn, Cn = function(t) {
        ...
        showValidationMessage: function(t) {
            ...
            n.customClass && n.customClass.validationMessage && gt(e.validationMessage, n.customClass.validationMessage),
        ...
        update: function(e) {
            ...
            if (!t || _(t, n.hideClass.popup))
                return z("You're trying to update the closed or closing popup, that won't work. Use the update() method in preConfirm parameter or show a new popup.");
            var o = {};
        ...
        _destroy: function() {
            ...
            e && (t.popup && oe.swalCloseEventFinishedCallback && (oe.swalCloseEventFinishedCallback(),
            delete oe.swalCloseEventFinishedCallback),
            oe.deferDisposalTimer && (clearTimeout(oe.deferDisposalTimer),
        ...
        function i() {
            ...
            "undefined" != typeof window) {
                "undefined" == typeof Promise && W("This package requires a Promise library, please include a shim to enable it in this browser (See: https://github.com/sweetalert2/sweetalert2/wiki/Migration-from-SweetAlert-to-SweetAlert2#1-ie-support)"),
                wn = this;
                for (var t = arguments.length, e = new Array(t), n = 0; n < t; n++)
                    e[n] = arguments[n];
    ...
    Object.keys(Q).forEach(function(t) {
        kn[t] = function() {
            if (wn)
                return wn[t].apply(wn, arguments)
        }
    }),
    kn.DismissReason = Z,
    kn.version = "10.10.4";
